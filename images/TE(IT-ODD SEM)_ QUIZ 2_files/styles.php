...
.mod-lesson .progress_bar_completed {
    ...
    background-image: url(http://14.142.126.126/moodle/mod/lesson/completed.gif);
...
.mod-lesson .progress_bar_todo {
    /*  Example Use of Image
    background-image: url(http://14.142.126.126/moodle/mod/lesson/todo.gif);
    background-repeat: repeat-x;
    background-position: center;
    */
    background-color: red;
...
.mod-lesson .progress_bar_token {
    /*  Example Use of Image
    background-image: url(http://14.142.126.126/moodle/mod/lesson/token.gif);
